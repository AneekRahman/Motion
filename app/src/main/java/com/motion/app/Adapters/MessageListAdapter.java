...
import com.motion.app.SubActivities.MessagingActivity;
...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    public static class MessageRowViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView msgUserName, msgMessage, boldMsgMessage, msgSentTime, msgYouTextView;
        ...
        public MessageRowViewHolder(View itemView) {
            ...
            this.boldMsgMessage = (TextView) itemView.findViewById(R.id.message_row_user_msg_bold);
    ...
    private void messageReceivedNotSeen(MessageRowViewHolder viewHolder, MessageListRow messageRow){
        ...
        viewHolder.msgMessage.setVisibility(View.GONE);
        viewHolder.boldMsgMessage.setVisibility(View.VISIBLE);

        viewHolder.msgUserName.setText(messageRow.getMsgUserName());
        viewHolder.boldMsgMessage.setText(messageRow.getMsgMessage());
    ...
    private void messageReceivedSeen(MessageRowViewHolder viewHolder, MessageListRow messageRow){
        ...
        viewHolder.msgYouTextView.setVisibility(View.GONE);
        viewHolder.boldMsgMessage.setVisibility(View.GONE);
        viewHolder.msgMessage.setVisibility(View.VISIBLE);
